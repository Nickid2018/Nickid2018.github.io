...
<font color="blue" size="+2">1.ASMifier: 自动生成ASM代码</font>
...
<font color="blue" size="+2">2.javap.exe: Java自带的字节码解析工具</font>
...
<font color="blue" size="+2">3.Eclipse插件: Enhanced Class Decompiler</font>
