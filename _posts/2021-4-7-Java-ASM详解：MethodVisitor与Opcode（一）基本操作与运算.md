...
<h2>三.局部变量表（Local Variable Table）</h2>
...
<h2>[加载字节码：<i>x</i>load与<i>x</i>load_<i>n</i>]</h2>
...
<h2>[存储字节码：<i>x</i>store与<i>x</i>store_<i>n</i>]</h2>
...
<h2>[常量池常量读取字节码：ldc（ldc_w, ldc2_w）]</h2>
...
<h2>[普通数字常量字节码：<i>x</i>const_<i>n</i>]</h2>
...
<h2>[int转换为其他基本类型的字节码：i2<i>x</i>]</h2>
